...
/**
* linep_withoutspaces - remove empty the spaces from beginning of
...
/**
* getHistoryHead - begins static head to struct hstory
...
/**
* getAliasHead - begins static head to struct alias
* for passing to functions
